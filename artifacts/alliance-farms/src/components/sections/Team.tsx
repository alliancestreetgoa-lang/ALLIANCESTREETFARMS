    ...
    <section id="team" className="py-28 bg-[#faf6ef] relative">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p variants={fadeUpSoft} className="text-[#5c3d1e] text-base font-normal italic max-w-2xl mx-auto leading-relaxed">
        ...
        >
          {TEAM.map((member) => (
            ...
            >
              ...
              <p className="text-[#5c3d1e] italic font-normal text-sm leading-relaxed">
                "{member.quote}"
              </p>
            </motion.div>
          ))}
